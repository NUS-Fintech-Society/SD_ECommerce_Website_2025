...
function DeleteListing_Drafts({ itemId, itemType}: { itemId: any, itemType: "listing" | "draft" }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await apiRequest(collection, "DELETE", `delete/${itemId}`);
  ...
  return (
    <>
      ...
      >
        <Trash2 size={20} />
        <span>Delete {itemType.charAt(0).toUpperCase() + itemType.slice(1)}</span>
      </button>
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>
              <Text>
                Are you sure you want to delete this {itemType}? This action cannot be undone and will
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>
              <Text>Your {itemType} has been successfully deleted.</Text>
            </AlertDialogBody>
            <AlertDialogFooter>
