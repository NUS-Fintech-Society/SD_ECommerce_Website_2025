            ...
            <div className="bg-blue-800">
                ...
                <div className="flex justify-between rounded-lg">
                    <h1 className="text-3xl text-white font-bold m-6">
                        {user?.isAdmin
                            ? "Request for Super Admin"
                            : "Request for Admin / Super Admin"}
                    </h1>
                    <p className="bg-gray-300 rounded-lg font-semibold my-6 mr-10 px-8 py-2 flex items-center justify-center">
                        {" "}
                        {user?.username}
                    </p>
                </div>
